...
define(['./workbox-3a267f26'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/cdnjs\.cloudflare\.com\/.*/i, new workbox.StaleWhileRevalidate({
