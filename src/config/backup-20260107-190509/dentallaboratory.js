...
const DentalLaboratory = {
    ...
    "DOES THE DENTAL LABORATORY HAVE THE FOLLOWING": {
        "showOnly": [
            ...
            "blasting machine",
            "magnifying lamp",
            "Soating basket or tray",
            "dental preparation sink",
            "clamp",
            "Denture flasks",
            "polishinh machine",
            "model trimmer",
            ...
            "vacuum curing unit",
            "Articulators",
            "sink fitted with filter",
            "Disinfectant",
            "dentures ( diffent sizes)",
            "gas",
            "retainers",
            "mouth guards",
            "bleaching tray",
    ...
    "IS THE DENTAL LABORATORY SUPPLIED WITH THE FOLLOWING PROTECTIVE GEAR": {
        "showOnly": [
            "Lab coats",
            "Face masks",
            "Goggles",
