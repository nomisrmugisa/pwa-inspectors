...
const 5 = {
    "Does the Facility have policies and procedures for Waste management?": {
        "showOnly": [
            ...
            "Does the consultation room have appropriate soap dispenser?",
            "Does the consultation room have a clinical waste bin with a lid?",
            "Does the consultation room have cotton wool/wipes?",
            "Does the consultation room have a domestic waste bin with a lid?",
            "Does the consultation room have an examination/treatment couch behind a curtain or located within a screened-off alcove to provide privacy?",
