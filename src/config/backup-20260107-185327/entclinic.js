...
const ENTclinic = {
    ...
    "CONSULTATION ROOM INSPECTION": {
        "showOnly": [
            ...
            "Does the consultation room have an audiometer?",
            "Does the consultation room have an autoclave?",
            "Does the consultation room have a cone and thudichum speculum (nasal and ear speculum)?",
            "Does the consultation room have a curette?",
            "Does the consultation room have an ear microscope?",
            "Does the consultation room have an endoscope and endoscopic light?",
            "Does the consultation room have an examination chair?",
        ]
    },
